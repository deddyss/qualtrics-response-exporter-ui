<template>
	<div class="min-w-0">
		...
		<div class="relative rounded-md shadow">
			...
			<input type="search" v-model="keyword" class="form-input focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 text-sm border-gray-300 rounded-md h-10" placeholder="Search" v-focus />
		</div>
	</div>
</template>
